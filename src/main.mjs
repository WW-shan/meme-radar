...
const scanner = new Scanner({ gmgn, secondary: new SecondaryValidator(), state, controls, chainSources: createChainEventSources(config), creatorReputation: new CreatorReputation(state.value.creatorHistory || []) });
